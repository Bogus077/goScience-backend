...
router.get('/attendance', [verifyJWT, isOfficer], getAttendanceRequest);
router.post('/memberAttendance', [verifyJWT, isOfficer], getMemberAttendanceRequest);
